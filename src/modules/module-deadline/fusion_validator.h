 ...
 * Sarkar 1989 §5.3) decide whether the macro-node admits a
 ...
 * (WOULD_SELF_SUSPEND, NON_CONVEX, INTERNAL_MILESTONE) are
 * all live; together they enforce the fusion-soundness
 * predicate stack the contracted-DAG dispatcher then trusts.
 */
